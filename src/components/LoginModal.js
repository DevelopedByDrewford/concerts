...
// WKWebView-based browsers on iOS (Chrome, Firefox, Brave, Edge) can't complete
// Google OAuth — popups are blocked and signInWithRedirect loses IndexedDB state
// across the cross-domain redirect chain. Safari is the only reliable path on iOS.
        ...
        {iosNonSafari ? (
          <div className="modal-safari-prompt">
            ...
            <p className="modal-safari-prompt__body">
              Google sign-in doesn't work in {iosBrowserName()} due to iOS browser restrictions. Copy the link below and paste it into Safari.
            </p>
